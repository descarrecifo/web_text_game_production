...
public class CharacterController {
    ...
    public static Player createPlayer() {
        ...
        Player player = new Player("Player", 1, playerInventory, 100, 10, 15, 10);
    ...
    public static NPC createEnemyPlaceholder(){
        ...
        switch (value){
            case 1 -> enemy = new NPC("Goblin", 5, createItem(), 20, 20, 5, 5);
            case 2 -> enemy = new NPC("Wolf", 5, createItem(), 10, 10, 15, 15);
            case 3 -> enemy = new NPC("Burglar", 5, createItem(), 25, 15, 15, 5);
            default -> enemy = new NPC("Soldier", 5, createItem(), 50, 25, 15, 5);
        }
