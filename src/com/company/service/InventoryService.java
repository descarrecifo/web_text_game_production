...
public class InventoryService {
    ...
    public static Item createItem() {
        ...
        switch (value) {
            ...
            case 2 -> reward = new Item("Wooden stick", "Wooden stick  ", "weapon", "A simple stick made of wood          ", 1, 1, 0, 0, true, false);

            case 3 -> reward = new Item("Sword", "Sword         ", "weapon", "A simple sword                       ", 7, 4, 0, 0, true, false);

            case 4 -> reward = new Item("Bow", "Bow           ", "weapon", "A simple bow                         ", 4, 2, 0, 0, true, false);

            case 5 -> reward = new Item("Great armour", "Great armour  ", "armour", "A heavy armour with a good defense   ", 15, 0, 10, -3, true, false);

            case 6 -> reward = new Item("Helmet", "Helmet        ", "armour", "A basic iron helmet                  ", 5, 0, 2, 0, true, false);

            case 7 -> reward = new Item("Dagger", "Dagger        ", "weapon", "A simple dagger                      ", 3, 2, 0, 0, true, false);
