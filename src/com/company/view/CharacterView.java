...
public class CharacterView {
    ...
    public static void presentationText(Player player){
        switch (player.getCharClass()){
            case "Cleric" -> System.out.println("\n"+baseText(player)+"You served the gods for years; your piety gained their favour, and now you can pray them asking for help in your fight against evil haunting the kingdom.");
            case "Mage" -> System.out.println("\n"+baseText(player)+"You studied the magical arts all your life, you have an special sense for the supernatural that will help you facing the evil of this land.");
            ...
            case "Warrior" -> System.out.println("\n"+baseText(player)+"You were a skinny boy when you started your training, but after years you know to use a lot of weapons. Now your kingdom needs you to save it from evil.");
        }
        System.out.println();
        gameLoopView(player);
