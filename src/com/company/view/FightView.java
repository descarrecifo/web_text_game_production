...
public class FightView {
    ...
    public static void fightingMessages(String value, NPC enemy, Player player) {
        switch (value) {
            ...
            case "3": {
                System.out.println("The enemy makes you " + YELLOW_BRIGHT + FightService.fightDamage(enemy, player) + " points " + ANSI_RESET + "of damage!");
                break;
            }
            case "4": {
                System.out.println("You makes " + YELLOW_BRIGHT + FightService.fightDamage(player, enemy) + " points " + ANSI_RESET + "of damage to your enemy!");
                break;
            }
            case "5": {
            ...
            case "9": {
                System.out.println("You have leveled up! Your level is now " + YELLOW_BRIGHT + player.getLevel() + ANSI_RESET);
                break;
            }
            case "10": {
                System.out.println("You're stronger! Now your strength is " + YELLOW_BRIGHT + player.getStrength() + ANSI_RESET + ", your defense is "
